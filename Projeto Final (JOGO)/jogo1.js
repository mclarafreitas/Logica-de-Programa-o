...
function fase1(){
  ...
  opcaoBotao(50, 200, 290, 300, 180, 50,1);
  opcaoBotao(50, 200, 365, 300, 180, 50,2);
  opcaoBotao(250, 200, 290, 300, 180, 50,3);
  opcaoBotao(250, 200, 365, 300, 180, 50,4);
...
function draw() {
  if (tela == 0) {
    ...
    textSize(25);
    fill(0);
    text("Jogar", xMinBotao + 30, yMinBotao3 + 40);
